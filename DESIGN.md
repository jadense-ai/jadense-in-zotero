...
- The five main navigation entries remain visible and correctly route to `对话 / 翻译历史 / 文献解析 / 连接攻玉 / 上手指南`; the analysis page exposes accessible `解析历史 / 解析配置` bookmark tabs.
